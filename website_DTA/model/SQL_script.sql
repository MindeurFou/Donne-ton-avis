...
(1, 'Films', 'Quel est le meilleur film de 2019 ?', '/website_DTA/images/top-films.jpg', 1, 'L\'année 2019 a été riche en chefs d\'oeuvres du cinéma... Cependant il est l\'heure d\'élire ceux qui vous ont le plus plût ! Donnez vôtre avis ici !', '2019-12-28', '2021-05-15', 0, 2000, 15, 0),
(2, 'Books', 'Quel est le meilleur livre de 2019 ?', '/website_DTA/images/top-livres.png', 1, 'Guillaume Musso, Stieg Larsson ou David Lagercrantz...Quel auteur vous a le \r\n	plus séduit cette année ?', '2019-12-27', '2021-02-03', 0, 2000, 15, 0),
(6, 'Series', 'Quel est le meilleur personnage de Friends ?', '/website_DTA/images/friends.jpg', 1, 'Friends est une de mes séries préférées ! Pas un seul épisode n\'a manqué de me faire rire !\r\nSorte d\'utopie de la vie en coloc, cette série regroupe 5 acteurs qui passent leur temps à se divertir et à rigoler entre eux. J\'aimerais connaître votre personnage préféré. Celui que vous avez trouvé le plus drôle ou bien celui avec qui joue le mieux, ou autre... A vous de décider !', '2020-05-13', '2020-08-20', 0, 32767, 15, 1);
