create database DTADB default character set utf8 COLLATE utf8_general_ci;
USE DTADB;
...
create table survey (
	...
	ImagePath varchar(30), -- chemin vers l'image correspondant au sondage
	IdAuthor varchar(60) not null,
	Description text not null,
	DateDebut date not null,
	DateFin date,
	NumberParticipants smallint unsigned default 0,
	NumberParticipantsMax smallint unsigned default 65535,
	NumberProposalMax smallint unsigned default 15,
...
create table proposal (
	...
	IdProposal bigint(20) not null auto_increment,
	IdSurvey bigint(20) not null, -- Sondage associé
	Title varchar(60) not null,
	...
	ClassementPosition smallint unsigned default null,
...
create table user (
	...
	UserName varchar(40) not null, -- pseudo
...
insert into proposal (IdSurvey, Title, ImagePath, IdAuthor, AuthorDescription, WikiDescription) values
	-- Adding proposals corresponding to survey 1 :
	(1,"Once Upon a Time in Holywood","images/once_upon_a_time_affiche.jpg",1,
	...
	différent des films de héros signé Marvel que l'on a l'habitude de voir.","Le nouveau film de Tarantino, il a fait un tabac auprès du public avec pas moins de 100 000 entrées sur les 6 
	...
	-- Adding proposals corresponding to survey 2 :
...
insert into user (UserName, FirstName, Name, Age) values
	("MindeurFou","Tanguy","Pouriel",20);


alter table proposal
	add foreign key (IdSurvey) references survey (IdSurvey),
	add foreign key (IdAuthor) references user (IdUser);
